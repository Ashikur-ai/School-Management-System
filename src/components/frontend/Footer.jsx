...
const Footer = () => {
  return (
    <div>
      <footer className="text-white body-font bg-themeBlue">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
            ...
            <div className="lg:w-1/6 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <img src="https://res.cloudinary.com/deifi77os/image/upload/v1735062830/School%20Management%20System/public/zazgqwpyefxxs8bqjau8.png" className='bg-white p-5 rounded-lg' alt="" />
              </nav>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 EIKRA —
              <a href="https://twitter.com/knyttneve" className="text-black ml-1" target="_blank" rel="noopener noreferrer">@ashikurRahman</a>
            </p>
